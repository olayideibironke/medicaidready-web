...
const PAGE_PATH = "/careers/reports/cybersecurity-jobs-hiring-now";
...
export default function CybersecurityJobsReport({ jobs, generatedAt }: Props) {
  ...
  const metaTitle = "Cybersecurity Jobs Hiring Now | MedicaidReady Careers";
  const metaDescription =
    "A MedicaidReady Careers report on cybersecurity, security engineering, cloud security, application security, vulnerability, SOC, and information security jobs currently hiring.";
  ...
  const itemListJsonLd = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Cybersecurity Jobs Hiring Now",
            ...
            <div className="careers-container report-hero-inner">
              ...
              <div className="report-hero-grid">
                <div>
                  ...
                  <h1>Cybersecurity Jobs Hiring Now</h1>
                  <p className="report-hero-copy">
                    A career intelligence brief for job seekers tracking cybersecurity,
                    security engineering, cloud security, application security, SOC,
                    vulnerability, identity access, and information security roles.
                  </p>

                  <div className="report-actions">
                    <Link href="/careers/jobs?category=cybersecurity" className="report-primary">
                ...
                <aside className="report-snapshot">
                  ...
                  <p>security-focused roles matched in the current job database</p>
              ...
              <div className="report-layout">
                <article className="report-main">
                  <section className="report-card">
                    ...
                    <h2>What cybersecurity hiring is showing</h2>
                    <p>
                      Cybersecurity hiring is not limited to one job title. Employers may use
                      titles such as Security Engineer, Security Analyst, Application Security
                      Engineer, Cloud Security Engineer, SOC Analyst, Information Security
                      Analyst, IAM Analyst, or Vulnerability Management Specialist.
                    </p>
                    <p>
                      Strong candidates usually show a mix of technical defense skills,
                      documentation, risk awareness, incident response thinking, cloud or
                      infrastructure familiarity, and the ability to communicate security issues
                  ...
                  <section className="report-card">
                    <div className="report-section-head">
                      <div>
                        ...
                        <h2>Security roles to review now</h2>
                      </div>
                      <Link href="/careers/jobs?category=cybersecurity">See all →</Link>
                    </div>

                    {topJobs.length === 0 ? (
                      <div className="report-empty">
                        <h3>No cybersecurity matches are active right now.</h3>
                        <p>
                          This report page is live and will update as new verified security
                          roles are imported into MedicaidReady Careers.
                        </p>
                      </div>
                    ) : (
                  ...
                  <section className="report-card">
                    ...
                    <h2>How to position yourself for cybersecurity roles</h2>
                    <div className="strategy-grid">
                      <div>
                        <h3>Match the security lane</h3>
                        <p>
                          Tailor your resume to the specific lane: SOC, cloud security,
                          application security, IAM, vulnerability management, governance, or
                          infrastructure security.
                        </p>
                      </div>
                      <div>
                        <h3>Show practical defense work</h3>
                        <p>
                          Highlight monitoring, threat detection, access control, incident
                          response, vulnerability remediation, policy support, or security
                          reviews when accurate.
                        </p>
                      </div>
                      <div>
                        <h3>Connect security to business risk</h3>
                        <p>
                          Employers want people who can explain why a security issue matters,
                          what risk it creates, and how the fix protects systems, data, users,
                          or operations.
                        </p>
                      </div>
                      <div>
                        <h3>Use tool names carefully</h3>
                        <p>
                          Include tools, cloud platforms, frameworks, ticketing systems, SIEM,
                          endpoint, identity, or vulnerability tools only when you can discuss
                          them honestly in an interview.
                        </p>
                      </div>
                    </div>
                  </section>
                ...
                <aside className="report-sidebar">
                  <div className="side-card">
                    ...
                    <div className="chip-list">
                      <Link href="/careers/jobs?query=Security%20Engineer">
                        Security Engineer
                      </Link>
                      <Link href="/careers/jobs?query=Cybersecurity%20Analyst">
                        Cybersecurity Analyst
                      </Link>
                      <Link href="/careers/jobs?query=Cloud%20Security">
                        Cloud Security
                      </Link>
                      <Link href="/careers/jobs?query=Application%20Security">
                        Application Security
                      </Link>
                    </div>
                  </div>
                  ...
                  <div className="side-card side-navy">
                    ...
                    <ul>
                      ...
                      <li>Cloud, infrastructure, and endpoint security</li>
                      <li>Identity access, governance, and controls</li>
                      <li>Incident response and security operations</li>
                      <li>Clear documentation and risk communication</li>
                    </ul>
                  </div>
