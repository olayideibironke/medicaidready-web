...
const PAGE_PATH = "/careers/reports/remote-program-analyst-jobs-this-week";
...
export default function RemoteProgramAnalystReport({ jobs, generatedAt }: Props) {
  ...
  const metaTitle = "Remote Program Analyst Jobs Hiring This Week | MedicaidReady Careers";
  const metaDescription =
    "A weekly MedicaidReady Careers report on remote Program Analyst, Project Analyst, Management Analyst, and program operations roles currently hiring.";
  ...
  const itemListJsonLd = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    name: "Remote Program Analyst Jobs Hiring This Week",
          ...
          <section className="report-hero">
            ...
            <div className="careers-container report-hero-inner">
              <div className="report-breadcrumbs">
                ...
                <span>/</span>
                <span>Weekly Hiring Report</span>
              </div>

              <div className="report-hero-grid">
                <div>
                  <p className="report-eyebrow">Weekly Hiring Report</p>
                  <h1>Remote Program Analyst Jobs Hiring This Week</h1>
                  <p className="report-hero-copy">
                    A practical career intelligence brief for job seekers tracking remote
                    Program Analyst, Project Analyst, Management Analyst, and program
                    operations roles across verified listings.
                  </p>
                  ...
                  <div className="report-actions">
                    ...
                    >
                      Browse Remote Program Analyst Jobs
                    </Link>
                    <Link href="/careers/insights" className="report-secondary">
                ...
                <aside className="report-snapshot">
                  ...
                  <p>remote analyst-style roles matched this week</p>
                  ...
                  <div className="snapshot-grid">
                    ...
                    <div>
                      ...
                      <strong>{salaryListedCount}</strong>
                    </div>
                    <div>
                      <span>Featured</span>
              ...
              <div className="report-layout">
                <article className="report-main">
                  <section className="report-card">
                    ...
                    <h2>What the remote Program Analyst market is showing</h2>
                    <p>
                      Remote Program Analyst roles are usually tied to teams that need
                      coordination, reporting, stakeholder follow-up, process tracking, and
                      operational support. These jobs may sit inside government contractors,
                      healthcare organizations, technology companies, nonprofits, public-sector
                      programs, and corporate operations teams.
                    </p>
                    <p>
                      The strongest applicants usually show evidence of organized communication,
                      project tracking, documentation, reporting, meeting coordination, data
                      cleanup, and the ability to move work forward across multiple people or
                      departments.
                    </p>
                  </section>
                  ...
                  <section className="report-card">
                    <div className="report-section-head">
                      <div>
                        ...
                        <h2>Remote roles to review now</h2>
                      </div>
                      <Link href="/careers/jobs?query=Program%20Analyst&workMode=remote">
                        See all →
                      </Link>
                    </div>
                    ...
                    {topJobs.length === 0 ? (
                      <div className="report-empty">
                        <h3>No remote Program Analyst matches are active right now.</h3>
                        <p>
                          This report page is live and will update as new verified jobs are
                          imported into MedicaidReady Careers.
                        </p>
                      </div>
                    ) : (
                  ...
                  <section className="report-card">
                    ...
                    <h2>How to position yourself for these roles</h2>
                    <div className="strategy-grid">
                      <div>
                        <h3>Show program coordination</h3>
                        <p>
                          Mention examples where you tracked deadlines, organized updates,
                          supported managers, coordinated stakeholders, or kept a project moving.
                        </p>
                      </div>
                      <div>
                        <h3>Show reporting comfort</h3>
                        <p>
                          Highlight Excel, dashboards, status reports, data cleanup, document
                          tracking, or any recurring reporting responsibilities.
                        </p>
                      </div>
                      <div>
                        <h3>Show remote readiness</h3>
                        <p>
                          Remote teams need clear writing, calendar discipline, meeting notes,
                          follow-up habits, and comfort working without constant supervision.
                        </p>
                      </div>
                      <div>
                        <h3>Use the right keywords</h3>
                        <p>
                          Strong resumes often include program support, project coordination,
                          stakeholder management, reporting, compliance, operations, and process
                          improvement.
                        </p>
                      </div>
                    </div>
                ...
                <aside className="report-sidebar">
                  <div className="side-card">
                    ...
                    <div className="chip-list">
                      ...
                      <Link href="/careers/jobs?query=Project%20Analyst&workMode=remote">
                        Remote Project Analyst
                      </Link>
                      <Link href="/careers/jobs?query=Management%20Analyst&workMode=remote">
                        Remote Management Analyst
                      </Link>
                      <Link href="/careers/jobs?query=Program%20Coordinator&workMode=remote">
                  ...
                  <div className="side-card side-navy">
                    ...
                    <ul>
                      <li>Program support and coordination</li>
                      <li>Status reporting and documentation</li>
                      <li>Stakeholder communication</li>
                      <li>Excel, dashboards, and tracking tools</li>
                      <li>Process improvement and operations support</li>
                    </ul>
                  </div>
                  ...
                  <div className="side-card">
                    ...
                    <div className="mini-links">
                      <Link href="/careers/insights">Weekly Hiring Reports</Link>
                      <Link href="/careers/jobs?query=Business%20Analyst&workMode=remote">
                        Remote Business Analyst Jobs
                      </Link>
                      <Link href="/careers/jobs?query=Data%20Analyst&workMode=remote">
